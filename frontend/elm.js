...
var author$project$Main$getQueryParams = F3(
	function (maybeInfo, direction, _arguments) {
		if (maybeInfo.$ === 'Nothing') {
			return _Utils_update(
				_arguments,
				{
					first: dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(4)
				});
		} else {
			...
			switch (direction.$) {
				...
				case 'Left':
					return _Utils_update(
						...
						{
							before: function () {
								var _n2 = info.startCursor;
								if (_n2.$ === 'Just') {
									var c = _n2.a;
									return dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(c);
								} else {
									return dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent;
								}
							}(),
							last: dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(4)
						});
				default:
					return _Utils_update(
						_arguments,
...
var author$project$Main$GridDataResponse = F2(
	function (pageInfo, persons) {
		return {pageInfo: pageInfo, persons: persons};
	});
var author$project$Main$PageInfo = F4(
	function (hasNextPage, hasPreviousPage, startCursor, endCursor) {
		return {endCursor: endCursor, hasNextPage: hasNextPage, hasPreviousPage: hasPreviousPage, startCursor: startCursor};
	});
...
var author$project$Schema$Object$PageInfo$endCursor = A4(
...
var author$project$Schema$Object$PageInfo$hasNextPage = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Bool', 'hasNextPage', _List_Nil, elm$json$Json$Decode$bool);
var author$project$Schema$Object$PageInfo$hasPreviousPage = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Bool', 'hasPreviousPage', _List_Nil, elm$json$Json$Decode$bool);
var author$project$Schema$Object$PageInfo$startCursor = A4(
	dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'startCursor',
	_List_Nil,
...
var author$project$Main$pageInfo = A2(
	dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	author$project$Schema$Object$PageInfo$endCursor,
	A2(
		dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		author$project$Schema$Object$PageInfo$startCursor,
		A2(
			dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			author$project$Schema$Object$PageInfo$hasPreviousPage,
			A2(
				dillonkearns$elm_graphql$Graphql$SelectionSet$with,
				author$project$Schema$Object$PageInfo$hasNextPage,
				dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(author$project$Main$PageInfo)))));
var author$project$Main$PersonSummary = F4(
	function (firstName, lastName, email, avatar) {
		return {avatar: avatar, email: email, firstName: firstName, lastName: lastName};
	});
var author$project$Schema$Object$Person$avatar = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'avatar', _List_Nil, elm$json$Json$Decode$string);
var author$project$Schema$Object$Person$email = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'email', _List_Nil, elm$json$Json$Decode$string);
var author$project$Schema$Object$Person$firstName = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'firstName', _List_Nil, elm$json$Json$Decode$string);
var author$project$Schema$Object$Person$lastName = A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'lastName', _List_Nil, elm$json$Json$Decode$string);
var author$project$Main$personSummary = A2(
	dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	author$project$Schema$Object$Person$avatar,
	A2(
		dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		author$project$Schema$Object$Person$email,
		A2(
			dillonkearns$elm_graphql$Graphql$SelectionSet$with,
			author$project$Schema$Object$Person$lastName,
			A2(
				dillonkearns$elm_graphql$Graphql$SelectionSet$with,
				author$project$Schema$Object$Person$firstName,
				dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(author$project$Main$PersonSummary)))));
...
var author$project$Schema$Object$PersonsConnection$edges = function (object_) {
	return A4(
...
var author$project$Schema$Object$PersonsConnection$pageInfo = function (object_) {
	return A4(dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField, 'pageInfo', _List_Nil, object_, elm$core$Basics$identity);
};
var author$project$Schema$Object$PersonsEdge$node = function (object_) {
	return A4(
		dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForCompositeField,
		'node',
		_List_Nil,
...
var author$project$Main$gridDataResponse = A2(
	dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	dillonkearns$elm_graphql$Graphql$SelectionSet$nonNullElementsOrFail(
		dillonkearns$elm_graphql$Graphql$SelectionSet$nonNullElementsOrFail(
			author$project$Schema$Object$PersonsConnection$edges(
				author$project$Schema$Object$PersonsEdge$node(author$project$Main$personSummary)))),
	A2(
		dillonkearns$elm_graphql$Graphql$SelectionSet$with,
		author$project$Schema$Object$PersonsConnection$pageInfo(author$project$Main$pageInfo),
		dillonkearns$elm_graphql$Graphql$SelectionSet$succeed(author$project$Main$GridDataResponse)));
var author$project$Schema$Enum$PersonSortEnum$toString = function (_enum) {
	switch (_enum.$) {
		case 'IdAsc':
			return 'ID_ASC';
		case 'IdDesc':
		...
		case 'EmailDesc':
			return 'EMAIL_DESC';
		case 'FirstNameAsc':
			return 'FIRST_NAME_ASC';
		case 'FirstNameDesc':
			return 'FIRST_NAME_DESC';
		case 'LastNameAsc':
...
var author$project$Schema$Query$persons = F2(
	function (fillInOptionals, object_) {
		var filledInOptionals = fillInOptionals(
			{after: dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, before: dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, first: dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, last: dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, sort: dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		var optionalArgs = A2(
			...
			_List_fromArray(
				[
					...
					'sort',
					filledInOptionals.sort,
					dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe(
							dillonkearns$elm_graphql$Graphql$Internal$Encode$enum(author$project$Schema$Enum$PersonSortEnum$toString)))),
...
var author$project$Main$gridQuery = F2(
	function (info, direction) {
		return A2(
			author$project$Schema$Query$persons,
			A2(author$project$Main$getQueryParams, info, direction),
			author$project$Main$gridDataResponse);
	});
...
var author$project$Main$loadGrid = F3(
	function (info, direction, serverUrl) {
		return A2(
			dillonkearns$elm_graphql$Graphql$Http$send,
			author$project$Main$GridLoaded,
			A2(
				dillonkearns$elm_graphql$Graphql$Http$queryRequest,
				serverUrl,
				A2(author$project$Main$gridQuery, info, direction)));
	});
var author$project$Main$init = F3(
	function (serverUrl, url, key) {
		return _Utils_Tuple2(
			{gridData: author$project$Main$Loading, key: key, lastPagination: author$project$Main$Initial, serverUrl: serverUrl, url: url},
			A3(author$project$Main$loadGrid, elm$core$Maybe$Nothing, author$project$Main$Initial, serverUrl));
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								gridData: author$project$Main$Loaded(data)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{gridData: author$project$Main$Errored}),
						elm$core$Platform$Cmd$none);
				}
			case 'PreviousPage':
				var _n2 = model.gridData;
				if ((_n2.$ === 'Loaded') && (_n2.a.$ === 'Just')) {
					var data = _n2.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{gridData: author$project$Main$Loading, lastPagination: author$project$Main$Left}),
						A3(
							author$project$Main$loadGrid,
							elm$core$Maybe$Just(data.pageInfo),
			...
			default:
				var _n3 = model.gridData;
				if ((_n3.$ === 'Loaded') && (_n3.a.$ === 'Just')) {
					var data = _n3.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{gridData: author$project$Main$Loading, lastPagination: author$project$Main$Right}),
						A3(
							author$project$Main$loadGrid,
							elm$core$Maybe$Just(data.pageInfo),
...
var author$project$Main$getAvatar = function (url) {
	return A2(
		elm$html$Html$img,
		_List_fromArray(
			[
...
var author$project$Main$getEmailLink = function (url) {
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
...
var author$project$Main$viewGrid = function (data) {
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											author$project$Main$getAvatar(row.avatar)
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$td,
									_List_Nil,
									_List_fromArray(
										[
											author$project$Main$getEmailLink(row.email)
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$td,
									_List_Nil,
									_List_fromArray(
										[
											elm$html$Html$text(row.firstName)
										])),
									A2(
									rundis$elm_bootstrap$Bootstrap$Table$td,
									_List_Nil,
									_List_fromArray(
										[
											elm$html$Html$text(row.lastName)
										]))
								]));
					},
					data.persons))));
...
var author$project$Main$viewNavigation = function (model) {
	var _n0 = model.gridData;
	if ((_n0.$ === 'Loaded') && (_n0.a.$ === 'Just')) {
		var data = _n0.a.a;
		return _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						!(data.pageInfo.hasPreviousPage || _Utils_eq(model.lastPagination, author$project$Main$Right))),
						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$PreviousPage)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Poprzednia strona')
					])),
				A2(
				rundis$elm_bootstrap$Bootstrap$Button$button,
				_List_fromArray(
					[
						rundis$elm_bootstrap$Bootstrap$Button$disabled(
						!(data.pageInfo.hasNextPage || _Utils_eq(model.lastPagination, author$project$Main$Left))),
						rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$Main$NextPage)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Następna strona')
					]))
			]);
	} else {
		return _List_fromArray(
									...
									switch (_n0.$) {
										...
										default:
											if (_n0.a.$ === 'Just') {
												...
												return _List_fromArray(
													[
														author$project$Main$viewGrid(page)
													]);
											} else {
												var _n1 = _n0.a;
												return _List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: function (_n0) {
			return author$project$Main$UrlChanged;
		},
